        ...
        >
          ...
          <motion.div 
            style={{ 
              ...
              x: useTransform(scrollYProgress, [0, 0.2], [0, -80]),
        ...
        <div className="flex w-full">
          ...
          <div className="flex-1 p-4 md:p-8 lg:p-20 space-y-20 md:space-y-32 min-h-screen z-0">
            ...
            <section id="additional-information">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-[#d4af37]">Additional Information</h2>
                 ...
                 {data.additionalInformation.map((item, index) => {
                   if (item === 'Biking') {
                     return (
                       <a
                         key={index}
                         href="#biking"
                         className="bg-[#111] h-40 rounded flex flex-col items-center justify-center text-xl hover:bg-[#222] hover:text-[#d4af37] border border-[#222] hover:border-[#d4af37]/30 transition-all cursor-pointer group"
                       >
                         <span>{item}</span>
                         <span className="text-xs text-gray-500 mt-2 group-hover:text-emerald-400 transition-colors">Click to view photos</span>
                       </a>
                     );
                   }
                   if (item === 'Certification') {
                     return (
                       ...
                       >
                         <span>{item}</span>
                         <span className="text-xs text-gray-500 mt-2 group-hover:text-emerald-400 transition-colors">Click to view credentials</span>
                       </a>
                     );
                   }
                   return (
                     <div key={index} className="bg-[#111] h-40 rounded flex items-center justify-center text-xl hover:bg-[#222] transition-colors">
                       {item}
                     </div>
                   );
                 })}
